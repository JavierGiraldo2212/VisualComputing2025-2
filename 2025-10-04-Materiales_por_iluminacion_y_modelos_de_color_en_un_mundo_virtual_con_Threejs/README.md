...
![Demostración del Mundo Virtual](renders/vid_taller.gif)

*Visualización completa del sistema: Vehículos con materiales PBR, iluminación dinámica, shaders procedurales y animaciones integradas. Se muestran los 4 presets de iluminación, el sistema de cámaras dual y los efectos de materiales físicamente correctos.*
